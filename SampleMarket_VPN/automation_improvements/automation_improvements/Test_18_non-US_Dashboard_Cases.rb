...
describe "Test 18: Dashboard, Email invite survey cases and reward checking" do
  ...
  it "To create a project to test the dashboard functionalities" do
   ...
   it "To Create a non-US group for Dashboard feature testing" do
       ...
       Country_value.should include("India")
...
=end
  ...
  it "Test to check if a client can enter PanelShield data successfully" do
   ...
   it "Test to confirm if a client can  enter the survey name and set the live close settings" do
    ...
    sleep 1
    group_name = File.open("InputRepository/Groupname_non-US_Dashboard.yml"){|file| YAML::load(file)}
...
#     @browser.link(:text,/#{@prj_name}/).click
  ...
  it "Test to check if non-US member is able to See a survey on dashboard for a live project" do
      ...
      @browser1 = @obj.Surveyhead_login("mayu_india@mailinator.com","mayu_india@mailinator.com")
      sleep 3
