...
describe "Test 37: Check for multiple clicks checkbox without uSamp channel" do
  ...
  before(:all) do
    ...
    it "Test to create a project on network site without uSamp channel" do
...
#    @browser.checkbox(:title,"Advantage Rent A Car").set
    ...
    it "Test to check if client can successfully complete creating the survey without uSamp Channel" do
    grp_name= Time.now
