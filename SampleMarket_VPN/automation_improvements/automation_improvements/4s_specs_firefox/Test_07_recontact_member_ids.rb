...
#    @browser.link(:text,/#{project_name['project'][1]}/).click
    ...
    #@browser.text_field(:name,"membersTokens").set("7641248,10648478,12002496")
    @browser.text_field(:name,"membersTokens").set("23238463,23238464,23236000")
	...
	sleep 2
        @browser.link(:text,"Next").click
        #@browser.text_field(:id,"txtSurveyUrl").set("http://www.s.instant.ly/s/XRtQG/??recontact=%%oldToken%%&id=%%Token%%")
        @browser.text_field(:id,"txtSurveyUrl").set("http://www.s.instant.ly/s/Nxxv2/nav#p/186a0/?recontact=%%oldToken%%&id=%%Token%%")
	sleep 2
