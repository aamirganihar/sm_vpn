...
describe "Test 22: Exclusion rules for dashboard" do
  ...
  it "To change settings of a survey to ensure that surveys is visible only if the member matches the exclusion criteria -Survey Complete include" do
    ...
    it "To check if a member is able to see a survey only if he satisfies the Survey Complete criteria" do
    ...
    it "To change settings of a survey to ensure that surveys is visible only if the member matches the exclusion criteria -Survey Complete exclude" do
...
=end      
    ...
    it "To check if a member is able to see a survey only if he satisfies the Survey Complete Exclusion criteria" do
      #Username = File.open("InputRepository/migrationdata.yml"){|file| YAML::load(file)}
      group_name = File.open("InputRepository/groupname_Demo.yml"){|file| YAML::load(file)}
      grp_name = group_name['group']
