...
describe "Test 01: Project creation" do
  ...
  it "Test to confirm if an error is reported if the mandatory fields which inclueds date and survey length are left blank on the project creation page" do
  ...
  it "Test to check if time in field are correctly displayed based on the start and end dates on the project creation page" do
      ...
      sleep 5
      body_text = @browser.text
      body_text.should include("Time in Field: 9 days 0 hour 0 minute")
  end
