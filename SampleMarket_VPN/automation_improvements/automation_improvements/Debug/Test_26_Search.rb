...
#    @browser.button(:id,"searchGoSB").click
  ...
  it "To Check if the search feature functions correctly for valid search of projects" do
    ...
    @browser.link(:text,/TESTAUTOMATIONPROJECTSEARCH - PR32057/).should exist
    @browser.text.should include("TESTAUTOMATIONPROJECTSEARCH - PR32057")
  end
