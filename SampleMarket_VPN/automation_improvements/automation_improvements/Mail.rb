...
Subject: SampleMarket automation suite has started - STAGE (firefox)

The SampleMarket client automation suite has started.<br><br>
...
#Net::SMTP.start('smtp.gmail.com', 587, 'gmail.com', 'selautomationmail@gmail.com', 'selautomationmail', :login) do |smtp|
#  smtp.send_message(message, 'qa@gmail.com', 'amogh_tarcar@persistent.co.in')
#end
...
Net::SMTP.enable_tls(OpenSSL::SSL::VERIFY_NONE)
Net::SMTP.start('smtp.gmail.com', 587, 'gmail.com', 'selautomationmail@gmail.com', 'selautomationmail', :login) do |smtp|
  smtp.send_message(message, 'qa@gmail.com', 'mayuri_rivankar@persistent.co.in')
end
=end

system ("SMTest.bat")

system ("SMsummary.bat")

test_result = File.open("InputRepository/results_stage.yml"){|file| YAML::load(file)}
...
From: USAMP QA Automation <USAMPQA@usamp.com>
To: usample_qa <usample_qa@persistent.co.in>; Abhijit Gaonkar <abhijit_gaonkar@persistent.co.in>; Steve Fernandes <steve_fernandes@persistent.co.in>; Vivek Samant <vivek_samant@persistent.co.in>
Subject: SampleMarket Client Application Report - STAGE (Firefox)
MIME-Version: 1.0
...
#Net::SMTP.start('smtp.gmail.com', 587, 'gmail.com', 'selautomationmail@gmail.com', 'selautomationmail', :login) do |smtp|
#  smtp.send_message(mailtext, 'qa@gmail.com', 'amogh_tarcar@persistent.co.in')
#end
...
Net::SMTP.start('smtp.gmail.com', 587, 'gmail.com', 'selautomationmail@gmail.com', 'selautomationmail', :login) do |smtp|
  smtp.send_message(mailtext, 'qa@gmail.com', 'mayuri_rivankar@persistent.co.in')
end
=end