...
=begin    
    ...
    ff = Selenium::Client::Driver.new \
      ...
      :port => 4444,
      :browser => "*chrome",
      :url => "https://p.network.u-samp.com/login.php",
...
#    ff.driver.start_new_browser_session(:captureNetworkTraffic => true)
    ...
    #ff.clear_cookies
    # Opening Usampadmin site
    #capabilities = Selenium::WebDriver::Remote::Capabilities.firefox #(:profile => "Selenium")    #(:javascript_enabled => true, :proxy=> Selenium::WebDriver::Proxy.new(:http => "localhost:5865"))
    #capabilities = Selenium::WebDriver::Remote::Capabilities.firefox (:profile => "Selenium")
    #ff = Watir::Browser.new(:remote, :url => "http://127.0.0.1:4444/wd/hub", :desired_capabilities => capabilities)
    #ff = Watir::Browser.new(:remote, :url => "http://127.0.0.1:4444/wd/hub", :desired_capabilities => capabilities)
    #ff = Watir::Browser.new(:remote, :desired_capabilities => capabilities)
    #ff = Watir::Browser.start("http://127.0.0.1:4444/wd/hub", :firefoxproxy, :remote)
