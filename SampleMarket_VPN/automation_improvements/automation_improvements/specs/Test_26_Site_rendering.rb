...
class Test_26_SH_rendering < Test::Unit::TestCase
	  ...
	  def test_02_spanish
			...
			begin
				...
				$ff.goto("http://www.p.surveyhead.com/?L=10")
				sleep 2
				$st = '1'
				$test_description = "Site rendering in SPANISH language"
				$myfile.print "<tr><td class=\"td1\">"+$st+"</td>"
				$myfile.print "<td class=\"td2\">"+$test_description+"</td>"
				if ($ff.contains_text("Se han destinado MILLONES de"))
	  ...
	  def test_03_deutch
			...
			begin
				$ff = FireWatir::Firefox.new
				$ff.goto("http://www.p.surveyhead.com/?L=4")
				sleep 2
				$st = '2'
				$test_description = "Site rendering in DEUTCH language"
				$myfile.print "<tr><td class=\"td1\">"+$st+"</td>"
				$myfile.print "<td class=\"td2\">"+$test_description+"</td>"
				if ($ff.contains_text("Unternehmen in der ganzen Welt sind bereit"))
	  ...
	  def test_04_french
			...
			begin
				$ff = FireWatir::Firefox.new
				$ff.goto("http://www.p.surveyhead.com/?L=3")
				sleep 2
				$st = '3'
				$test_description = "Site rendering in FRENCH language"
				$myfile.print "<tr><td class=\"td1\">"+$st+"</td>"
				$myfile.print "<td class=\"td2\">"+$test_description+"</td>"
				if ($ff.contains_text("Des entreprises du monde entier sont"))
	  ...
	  def test_05_italian
			...
			begin
				$ff = FireWatir::Firefox.new
				$ff.goto("http://www.p.surveyhead.com/?L=5")
				sleep 2
				$st = '4'
				$test_description = "Site rendering in ITALIAN language"
				$myfile.print "<tr><td class=\"td1\">"+$st+"</td>"
				$myfile.print "<td class=\"td2\">"+$test_description+"</td>"
				if ($ff.contains_text("Le aziende di tutto il mondo sono disposte a"))
	  ...
	  def test_06_portuguse
			...
			begin
				$ff = FireWatir::Firefox.new
				$ff.goto("http://www.p.surveyhead.com/?L=13")
				sleep 2
				$st = '1'
				$test_description = "Site rendering in PORTUGUESE language"
				$myfile.print "<tr><td class=\"td1\">"+$st+"</td>"
				$myfile.print "<td class=\"td2\">"+$test_description+"</td>"
				if ($ff.contains_text("As empresas do mundo todo"))
