...
class Test_31_Merge_field_survey_url < Test::Unit::TestCase
	  ...
	  def test_03_check_merge_fields
		...
		begin	
			...
			$myfile.print "<tr><td class=\"td1\">"+$st+"</td>"
			$myfile.print "<td class=\"td2\">"+$test_description+"</td>"
			if ($url == "http://203.199.26.75/usamp/TEST_SURVEY.php?SHA=218dc9724725dfc0f1ba4d3da606ee266d3ade60&MEM_NO=10598227&ENC_MEM_NO=Y4vwDOmmu&AGE=36&CHILDRN=2&ETHNICITY=9&EDUC=6&GEN=1&INCOME=22&MAR_STATUS=1&ZIP=90001&PID=0&SP_ID=&EMAIL=gsk@hk.com&COUNTY=06037&STATE=06&DMA=803&TOKEN=") 
				puts "pass"
