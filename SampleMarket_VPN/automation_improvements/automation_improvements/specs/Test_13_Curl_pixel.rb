...
class Test_13_Curl_Pixel < Test::Unit::TestCase
	  ...
	  def test_08_checkpoints
			...
			begin	  
				  ...
				  sleep 5
				  if ($ie.contains_text($mid) && $ie.contains_text($s) && $ie.contains_text($sp))
							$myfile.print "<td class=\"td3\"><font color=\"green\">TEST PASSED</font></td></tr>"
				  else
							$myfile.print "<td class=\"td3\"><font color=\"red\">TEST FAILED</font></td></tr>"
				  end
				  ...
				  if ($ie.contains_text($pix_cpi) && $ie.contains_text($qg_dsc) && $ie.contains_text($pix_rew) && $ie.contains_text($qg_id))
							$myfile.print "<td class=\"td3\"><font color=\"green\">TEST PASSED</font></td></tr>"
				  else
							$myfile.print "<td class=\"td3\"><font color=\"red\">TEST FAILED</font></td></tr>"
				  end
				  ...
				  if ($ie.contains_text($qg_dsc) && $ie.contains_text($qg_id))
					    	$myfile.print "<td class=\"td3\"><font color=\"green\">TEST PASSED</font></td></tr>"
				  else
					    	$myfile.print "<td class=\"td3\"><font color=\"red\">TEST FAILED</font></td></tr>"
				  end
				  ...
				  if ($ie.contains_text($pix_prof_dsc) && $ie.contains_text($pix_prof_rew) && $ie.contains_text($prof_id))
				  		$myfile.print "<td class=\"td3\"><font color=\"green\">TEST PASSED</font></td></tr>"
				  else
							$myfile.print "<td class=\"td3\"><font color=\"red\">TEST FAILED</font></td></tr>"
				  end
