...
#include 'Suite'
require 'base64'
require 'Input Repository\Test_42_QG_notifications_Input.rb'

class Test_42_QG_notifications < Test::Unit::TestCase
	  ...
	  def test_03_set_QG_notifications_no_redirection_activity
			...
			begin	
				...
				$ie.select_list(:name, "noRedActivityTbl[]").set($employee)
				...
				$myfile.print "<tr><td class=\"td1\">"+$st+"</td>"
				$myfile.print "<td class=\"td2\">"+$test_description+"</td>"
				if ($ie.contains_text(/Notification settings have been updated successfully/))
					puts "Pass"
