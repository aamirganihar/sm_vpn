...
describe "Production Panelshield tests" do

  before(:all) do
	  driver = Selenium::WebDriver.for :firefox, :profile => "Selenium"
      @browser = Watir::Browser.new driver
      @browser.goto('https://p.network.u-samp.com/login.php')
      @browser.radio(:value, "Client").set
      @browser.text_field(:id, "txtEmail").set("nitin_kumar@persistent.co.in")
      @browser.text_field(:id, "txtPassword").set("test")
      #Click login button
    ...
    it "To successfully create a Panelshield project" do
        @browser.goto("https://p.network.u-samp.com/pshield/ps_welcome.php")
	...
	it "To successfully add a supplier to a Panelshield project" do
		...
		@browser.select_list(:id,"supplierList").select "Test RH"
