...
Subject: SampleMarket automation suite has started - STAGE (Chrome)
...
Subject: SampleMarket Client Application Report - STAGE (Chrome)
MIME-Version: 1.0
...
system ("Chrome_Firefox_killer.bat")
system ("IM_Suite_Updated.bat")
