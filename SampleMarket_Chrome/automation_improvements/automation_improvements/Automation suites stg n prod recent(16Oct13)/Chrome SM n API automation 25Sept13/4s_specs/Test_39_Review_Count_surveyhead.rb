...
describe "Test 39: Review Counts with Demographic Criteria, Geographic Criteria and matching panel book questions for Surveyhead site" do
...
#    @browser.link(:text,/#{project_name['project'][1]}/).click
    @browser.link(:text,/Group Setup/).click
     Watir::Wait.until { @browser.text.include? 'GROUP CRITERIA' }#explicit wait:default timeout :30sec:HRISHI
    sleep 7
