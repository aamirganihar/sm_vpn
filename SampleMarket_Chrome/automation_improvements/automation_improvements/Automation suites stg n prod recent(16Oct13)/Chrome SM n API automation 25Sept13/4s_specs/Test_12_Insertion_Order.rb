...
describe "Test 12: Insertion Order page" do
  ...
  before(:all) do
	...
	body_text.should include("Estimated Start Date: #{@date_added_1} 01:00 AM PST")
      body_text.should include("Estimated End Date: #{@date_added_10} 01:00 AM PST")
      ...
      body_text.should include("Estimated Field Period: 9 days 0 hour 0 minute") #Change for Day light savings
      #body_text.should include("Estimated Field Period: 9 days 1 hour 0 minute")
