...
#    @browser.link(:text,/#{project_name['project'][1]}/).click
    ...
    @browser.text_field(:name,"membersTokens").set("227fa25596f6f718c71a978d5605d0b4,227fa25596f6f718694de85d3bda5c25,227fa25596f6f7187fa49b38d166d29d")
end    
  ...
  it "Test to check if client can successfully complete creating the survey with a specific recontact token" do
   ...
   @browser.link(:id,"btnApply").click
    ...
    sleep 2
    @browser.link(:text,"Next").click
    @browser.text_field(:id,"txtSurveyUrl").set("http://www.instant.ly/s/gxZWu/?recontact=%%oldToken%%&id=%%Token%%")
    sleep 2
