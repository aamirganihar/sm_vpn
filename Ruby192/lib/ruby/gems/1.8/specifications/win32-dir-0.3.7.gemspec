...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGES", "examples/dir_example.rb", "lib/win32/dir.rb", "MANIFEST", "Rakefile", "README", "test/test_win32_dir.rb", "win32-dir.gemspec"]
  ...
  s.test_files = ["test/test_win32_dir.rb"]
