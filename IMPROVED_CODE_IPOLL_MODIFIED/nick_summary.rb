...
$out_fl_path = $wd+"/Output Repository/Non4S_Test_Report_.html"
#puts $out_fl_path
...
filename = $wd+"/Output Repository/Non4S_Test_Report_.html"
...
=begin
summary =<<EOF
<h1><u><b>Test Automation Summary</b></u></h1><br>
<font color="green">Test Cases Passed: #{$pass}<br>
<font color="red">Test Cases Failed:#{$fail}<br>
<font color="black">Test Cases Not Completed:#{$incomplete}<br>

Please go through the attachment for the detailed report<br>
EOF
=end
