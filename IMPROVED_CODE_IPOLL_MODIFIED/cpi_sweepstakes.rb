...
$ie.button(:name, "btnAddNew").click
$ie.radio(:value, "Sweepstakes").set
sleep 2
$ie.button(:name, "btnDone").click
sleep 2
...
$ie.radio(:value, "perc_after_reward_cpi").set
...
$ff = $obj.Surveyhead_login($em_id1,$em_id1)
