...
class Test_59_Confirmit_code_url_recontact < Test::Unit::TestCase
	  ...
	  def test_03_confirmit_code__recon_qg_set
			...
			begin	
				...
				$myfile.print "<tr><td class=\"td1\">"+$st+"</td>"
				$myfile.print "<td class=\"td2\">"+$test_description+"</td>"
				if($ie.checkbox(:id, "chkAppendClientCodes").set?)
					puts "PASS"
				...
				$myfile.print "<tr><td class=\"td1\">"+$st+"</td>"
				$myfile.print "<td class=\"td2\">"+$test_description+"</td>"
				if($ie.checkbox(:id, "chkRecontactStudy").set?)
					puts "PASS"
					$myfile.print "<td class=\"td3\"><font color=\"green\">TEST PASSED</font></td></tr>"
				else
					puts "FAIL"
				...
				$ie.goto("q.usampadmin.com/add_quota_group.php?project_id=#{$prj_n}&quota_group_id=#{$qg_n}")
				sleep 4
				$ie.button(:id, "btnCodeURLRecontact").click
				sleep 5
				...
				if($ie.html.include?("File (1 CODE) has been succesfully uploaded"))
					puts "PASS"
          puts "file uploaded successuflly"
					$myfile.print "<td class=\"td3\"><font color=\"green\">TEST PASSED</font></td></tr>"
				else
					puts "FAIL"
	...
	def test_05_confirmit_code_survey_complete
	  ...
	  def test_06_confirmit_url_qg_set
			...
			begin
				...
				$myfile.print "<tr><td class=\"td1\">"+$st+"</td>"
				$myfile.print "<td class=\"td2\">"+$test_description+"</td>"
				if($ie.radio(:id, "rdSurveyURLType2").set?)
					puts "PASS"
					$myfile.print "<td class=\"td3\"><font color=\"green\">TEST PASSED</font></td></tr>"
				else
					puts "FAIL"
				...
				#$ie.button(:value,"Code/URL for Re-contact").click
				$ie.button(:id, "btnCodeURLRecontact").click
				sleep 4
