...
class Test_64_Email_clicks_allowed < Test::Unit::TestCase
	  ...
	  def test_03_save_no_of_clicks_set
			...
			begin		
				...
				$myfile.print "<tr><td class=\"td1\">"+$st+"</td>"
				$myfile.print "<td class=\"td2\">"+$test_description+"</td>"
				if (($val == "2") && $ie.html.include?('Panelshield details have been updated successfully'))
					puts "PASS"
					$myfile.print "<td class=\"td3\"><font color=\"green\">TEST PASSED</font></td></tr>"
				else
					puts "FAIL"
	  ...
	  def test_05_check_survey_clicks
			...
			begin	
				...
				$myfile.print "<tr><td class=\"td1\">"+$st+"</td>"
				$myfile.print "<td class=\"td2\">"+$test_description+"</td>"
				if($ff.text.include?($qg_id) && $ff.html.include?('You may qualify for this survey'))
					puts"FAIL"
					$myfile.print "<td class=\"td3\"><font color=\"red\">TEST FAILED</font></td></tr>"
				else
					puts "PASS"
	  ...
	  def test_06_reset_no_of_clicks_setting
			...
			begin	
				...
				$myfile.print "<tr><td class=\"td1\">"+$st+"</td>"
				$myfile.print "<td class=\"td2\">"+$test_description+"</td>"
				if ($val == "999" && $ie.html.include?('Panelshield details have been updated successfully'))
					puts "PASS"
					$myfile.print "<td class=\"td3\"><font color=\"green\">TEST PASSED</font></td></tr>"
				else
					puts "FAIL"
	  ...
	  def test_07_check_survey_clicks_after_reverting
			...
			begin	
				...
				$myfile.print "<tr><td class=\"td1\">"+$st+"</td>"
				$myfile.print "<td class=\"td2\">"+$test_description+"</td>"
				if($ff.html.include?('THIS IS A TEST AUTOMATION SURVEY'))
					puts "PASS"
					$myfile.print "<td class=\"td3\"><font color=\"green\">TEST PASSED</font></td></tr>"
				else
					puts"FAIL"
